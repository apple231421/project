...
<body>
	<form action="form5_process" method="post">
	...
	운동<input type="checkbox" name="hobby" value="운동">
		양화<input type="checkbox" name="hobby" value="영화">
		<p><textarea name="content" rows="5" cols="30" placeholder="가입인사를 입력해주세요"></textarea>
